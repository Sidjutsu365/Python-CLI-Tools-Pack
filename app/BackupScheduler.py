...
class BackupScheduler:
    ...
    def backup(self):
        ...
        self.logger.info(f'Starting schedule and create dirs...')
    ...
    def _make_dir(self):
        ...
        now = datetime.now().strftime('%Y-%m-%d_%H-%M') # Set format of time for the name of dir
        ...
        try:
            copytree(self.source, new_dir, dirs_exist_ok = True) # Copy files from source to destination
